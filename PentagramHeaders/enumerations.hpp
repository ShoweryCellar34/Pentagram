...
enum eventCallbackFlags : unsigned char {
    PNT_EVENT_CALLBACK_FLAGS_KEYBOARD,
    PNT_EVENT_CALLBACK_FLAGS_SCROLL,
    PNT_EVENT_CALLBACK_FLAGS_CURSORPOS,
    PNT_EVENT_CALLBACK_FLAGS_MOUSEBUTTON,
    PNT_EVENT_CALLBACK_FLAGS_COUNT
};
